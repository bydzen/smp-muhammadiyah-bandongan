                            ...
                            <?php
                                ...
                                if(isset($_POST['submit'])){
                                    ...
                                    if($_FILES['logo_baru']['name'] !=''){
                                        ...
                                        $allowedtype_logo    = array('png', 'jpg', 'jpeg', 'gif', 'JPG', 'JPEG');

                                        if(!in_array($formatfile_logo, $allowedtype_logo)){
                                            echo '<div class= "alert alert-error">Format file logo sekolah tidak sesuai</div>';
                                            return false;

                                            }elseif($filesize_logo>10000000){

                                                echo '<div class= "alert alert-error">Ukuran file logo sekolah tidak boleh lebih dari 10MB</div>';
                                                return false;
                                            }else{
                                    ...
                                    if($_FILES['favicon_baru']['name'] !=''){
                                        ...
                                        $allowedtype_favicon    = array('png', 'jpg', 'jpeg', 'gif', 'JPG', 'JPEG');
                                        ...
                                        if(!in_array($formatfile_favicon, $allowedtype_favicon)){
                                            ...
                                            }elseif($filesize_favicon>10000000){

                                                echo '<div class= "alert alert-error">Ukuran file favicon sekolah tidak boleh lebih dari 10MB</div>';
                                                return false;
                                            }else{
